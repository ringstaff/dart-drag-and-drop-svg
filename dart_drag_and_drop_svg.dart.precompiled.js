...
main: function() {
  var app, t1, t2;
  app = new O.Application(80, 60, null);
  app.canvas = document.querySelector("#app_container");
  t1 = app.canvas;
  t1.toString;
  t1 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_dblclick._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = app.get$addNewUnit();
...
Application: {"": "Object;WIDTH,HEIGHT,canvas",
  ...
  get$addNewUnit: function() {
    return new H.BoundClosure$1(this, O.Application.prototype.addNewUnit$1, null, "addNewUnit$1");
  }
}},
1],
